...
describe("HeroLevel", () => {
  ...
  it(`should return "${label.prata}" when between 2.001 ~ 5.000`, () => {
    expect(hero.get(3000)).toEqual(label.prata);
  });
  it(`should return "${label.ouro}" when between 5.001 ~ 7.000`, () => {
    expect(hero.get(6000)).toEqual(label.ouro);
  });
  it(`should return "${label.platina}" when between 7.001 ~ 8.000`, () => {
    expect(hero.get(7500)).toEqual(label.platina);
  });
  it(`should return "${label.ascendente}" when between 8.001 ~ 9.000`, () => {
    expect(hero.get(8600)).toEqual(label.ascendente);
  });
  it(`should return "${label.imortal}" when between 9.001 ~ 10.000`, () => {
